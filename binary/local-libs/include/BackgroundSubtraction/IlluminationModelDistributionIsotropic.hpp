 ...
 *
 * $Id: IlluminationModelDistributionIsotropic.hpp 1902 2010-12-06 12:56:08Z guillaume $
 */

#ifndef ILLUMINATION_MODEL_DISTRIBUTION_ISOTROPIC_HPP
#define ILLUMINATION_MODEL_DISTRIBUTION_ISOTROPIC_HPP
...
namespace Vi
{
   ...
   */
  class EXPORT_TYPE IlluminationModelDistributionIsotropic
  {
  public:
     ...
     * Constructor.
     */
    IlluminationModelDistributionIsotropic(unsigned int fDimension);
    
    /**
     * Destructor.
     */
    ~IlluminationModelDistributionIsotropic();
     ...
     *
     * \param[in] fFrame The first frame of the sequence.    
     */
    void init(const Vi::Image<> &fFrame);
     ...
     *
     * \param[in]       fPixelValues The value(s) of the pixel in each channel.
     ...
     */
    void computePixelBeliefs(float* const fPixelValues, float* const fPixelRatios, float *fPixelBeliefs);
     ...
     */
    void updateAccumulators(float* const fPixelValues, float* const fPixelRatios, float* const fPixelBeliefs); 
    ...
    unsigned int mNbModesForeground; ///< Number of modes for the background (i.e. K_bar).
    unsigned int mNbModesTotal;      ///< Number of modes in total.
...
#endif // ILLUMINATION_MODEL_DISTRIBUTION_ISOTROPIC_HPP
