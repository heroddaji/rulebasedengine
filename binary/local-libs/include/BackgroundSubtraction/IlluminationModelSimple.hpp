/** \file
 * Illumination Model Simple for background subtraction prototype.
 *
...
#ifndef ILLUMINATION_MODEL_SIMPLE_HPP
#define ILLUMINATION_MODEL_SIMPLE_HPP

#include <ViNotion/Compat.hpp>
#include <ViNotion/Image.hpp>

#include "IlluminationModelSimpleParams.hpp"
#include "IlluminationModelDistributionSimple.hpp"
...
namespace Vi
{
   ...
   * Illumination model
   */
  class EXPORT_TYPE IlluminationModelSimple : public Vi::BackgroundModel
  {
  public:
     ...
     */
    IlluminationModelSimple(const Vi::Image<> &fFrame);
    
    /**
     * Destructor.
     */
    ~IlluminationModelSimple();
  ...
  private:
    ...
    IlluminationModelDistributionSimple *illumDistrib; ///< The distribution.
    float ***mBackgroundModel;                            ///< The background model.

    /// XXX
    Vi::Image<> mFrame;              ///< The current frame.
    ...
    Vi::Image<> mBackgroundImage;    ///< The background image.
  };
}
